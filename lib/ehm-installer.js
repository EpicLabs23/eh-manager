...
export const performEhmInstall = async ({ version, mysqlRootPassword, apiPublicUrl, os, influxEnabled, encryptionKey }) => {
  ...
  try {
    ...
    if (fs.existsSync(installScript)) {
      ...
      // Quote every arg — an unquoted empty arg vanishes in shell word-splitting,
      // shifting every positional argument after it. See ehm-updater.js.
      const args = [version, mysqlRootPassword, apiPublicUrl, influxEnabled, encryptionKey]
