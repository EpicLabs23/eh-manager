...
export const performEhmInstall = async ({ version, mysqlRootPassword, apiPublicUrl, os, influxEnabled }) => {
  ...
  try {
    ...
    if (fs.existsSync(installScript)) {
      ...
      execSync(`bash ${installScript} ${version} ${mysqlRootPassword} ${apiPublicUrl} ${influxEnabled}`, { stdio: 'inherit' });
    } else {
