...
export const getInfluxEnabled = async (defaultValue = false) => {
    return await inquirer.prompt({
        type: 'confirm',
        name: 'influxEnabled',
        message: 'Enable InfluxDB metrics history? (requires InfluxDB already installed, see eh-services/influxdb)',
